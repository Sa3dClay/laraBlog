                            ...
                            @foreach ($feedbacks as $feedback)
                                <tr>
                                    ...
                                    @if($feedback->closed == 0)
                                      <td>
                                        <a href="{{ url('/feedbacks'. '/' .$feedback->id . '/'.auth()->user()->id. '/' .'responses') }}"
                                            class="btn btn-sm btn-success">Respond <i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
                                      </td>
                                    @else
                                      <td>
                                    ...
                                    @if($feedback->closed == 0)
                                      <td>
                                        <a href="{{ url('admin/feedbacks'. '/' .$feedback->id . '/close') }}"
                                            class="btn btn-sm btn-dark">close <i class="fas fa-folder"></i></a>
                                      </td>
                                    @else
                                      <td>
                                    ...
                                    <td>
                                        {!! Form::open([
                                            ...
                                            <button type="button"class="btn btn-sm btn-danger deletePost">Delete
